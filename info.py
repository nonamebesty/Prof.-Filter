...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://mvideo:mvideo@cluster0.bpj54.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# url shortner
SHORT_URL = environ.get("SHORT_URL", 'primeurl.in')
SHORT_API = environ.get("SHORT_API", '52d270ec96e971ba3c93464277f5c0393f053287')

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002396553917'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviekoodu')
